...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        var v30 = v1[1] * v2[2] - v1[2] * v2[1];
        var v31 = -1 * (v1[0] * v2[2] - v1[2] * v2[0]);
        var v32 = v1[0] * v2[1] - v1[1] * v2[0];

        let v3 = new Vector3([v30, v31, v32]); // Modify this line to calculate cross product between other1 and other2.
        //v3.print();
        // Don't delete the return statement.
        return v3;
    }
    ...
    magnitude() {
        // Insert your code here.
        let calc = ((this.elements[0])**2) + ((this.elements[1])**2) + ((this.elements[2])**2);
        let m = Math.sqrt(calc); // Modify this line to calculate this vector's magnitude.
    ...
    normalize() {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        var temp1 = this.elements[0] / this.magnitude();
        var temp2 = this.elements[1] / this.magnitude();
        var temp3 = this.elements[2] / this.magnitude();

        this.elements = [temp1, temp2, temp3];
        // Don't delete the return statement.
        return this;
    };

    print() {
      console.log(this.elements[0],this.elements[1],this.elements[2]);
    }
}
